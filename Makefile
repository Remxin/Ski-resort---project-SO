...
# Dependencies
$(BUILD_DIR)/main.o: $(SRC_DIR)/main.c $(INCLUDE_DIR)/skier.h $(INCLUDE_DIR)/utils.h $(INCLUDE_DIR)/cashier.h $(INCLUDE_DIR)/ticket.h $(INCLUDE_DIR)/shared_memory.h $(INCLUDE_DIR)/config.h
